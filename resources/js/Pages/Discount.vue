...
<template>
    <NewLayout title="Discount">
        <template #content>
            <div class="max-w-7xl mx-auto container-xxl py-3 mb-4 sm:px-6 lg:px-8">
                <div class="p-3 mb-2 bg-light text-dark">Discount</div>
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        <p class="demo-inline-spacing">
          ...
          <Link :href="route('adddiscount')" class="btn btn-primary me-1 waves-effect waves-light collapsed">
            Add your discount
        </Link>
